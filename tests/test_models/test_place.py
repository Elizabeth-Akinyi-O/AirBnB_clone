...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        plc = Place()
        plc.id = "123456"
        plc.created_at = plc.updated_at = da_ti
        plcstr = plc.__str__()
        self.assertIn("[Place] (123456)", plcstr)
        self.assertIn("'id': '123456'", plcstr)
        self.assertIn("'created_at': " + da_ti_repr, plcstr)
        self.assertIn("'updated_at': " + da_ti_repr, plcstr)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        plc = Place(id="345", created_at=da_ti_iso, updated_at=da_ti_iso)
        self.assertEqual(plc.id, "345")
        self.assertEqual(plc.created_at, da_ti)
        self.assertEqual(plc.updated_at, da_ti)
