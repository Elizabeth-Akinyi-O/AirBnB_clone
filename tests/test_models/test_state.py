...
class TestState_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        st = State()
        st.id = "123456"
        st.created_at = st.updated_at = da_ti
        ststr = st.__str__()
    ...
    def test_instantiation_with_kwargs(self):
        ...
        st = State(id="345", created_at=da_ti_iso, updated_at=da_ti_iso)
        self.assertEqual(st.id, "345")
        self.assertEqual(st.created_at, da_ti)
        self.assertEqual(st.updated_at, da_ti)
