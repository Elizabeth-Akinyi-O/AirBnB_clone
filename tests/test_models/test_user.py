...
class TestUser_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        usr = User()
        usr.id = "123456"
        usr.created_at = usr.updated_at = da_ti
        usrstr = usr.__str__()
        self.assertIn("[User] (123456)", usrstr)
        self.assertIn("'id': '123456'", usrstr)
        self.assertIn("'created_at': " + da_ti_repr, usrstr)
        self.assertIn("'updated_at': " + da_ti_repr, usrstr)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        usr = User(id="345", created_at=da_ti_iso, updated_at=da_ti_iso)
        self.assertEqual(usr.id, "345")
        self.assertEqual(usr.created_at, da_ti)
        self.assertEqual(usr.updated_at, da_ti)
