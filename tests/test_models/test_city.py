...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        cty = City()
        cty.id = "123456"
        cty.created_at = cty.updated_at = da_ti
        ctystr = cty.__str__()
        self.assertIn("[City] (123456)", ctystr)
        self.assertIn("'id': '123456'", ctystr)
        self.assertIn("'created_at': " + da_ti_repr, ctystr)
        self.assertIn("'updated_at': " + da_ti_repr, ctystr)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        cty = City(id="345", created_at=da_ti_iso, updated_at=da_ti_iso)
        self.assertEqual(cty.id, "345")
        self.assertEqual(cty.created_at, da_ti)
        self.assertEqual(cty.updated_at, da_ti)
